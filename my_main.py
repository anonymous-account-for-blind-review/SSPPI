...
if __name__ == '__main__':
    ...
    parse.add_argument('--identity', type = str, default='01', choices=['01','10','25','40','any','s1','s2'])
    parse.add_argument('--mode', type=str, default='warm', choices=['warm', 'cold'])
